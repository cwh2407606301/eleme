  ...
  <div class="food" v-if="showFlag" ref="food">
    <div class="food-content">
      ...
      <div class="rating">
        ...
        <ratingselect @change-type="changeType" @switch-onlycontent="switchOnlyContent" :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings="food.ratings"></ratingselect>
